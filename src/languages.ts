const languages = {
  ...
  finnsih: {
    name: "finnish",
    navItems: ["Minä", "Kokemus", "Projektit"],
    mainItems: [
      "Minä",
      "Kokemus",
      "Projektit",
    ...
    projects: [
      {
        ...
        about:
          "React.js pohjainen frontti Open Trivia Database API:lle. Open Trivia DB:n on kehittänyt ja ylläpitää PIXELTAIL GAMES LLC.",
      },
      {
        ...
        link: "https://konstanenonen.github.io/Pomodoro-Timer/",
        about:
          "Ajastin opiskeluun ja keskittymiseen. Tämä oli viimeinen projekti freeCodeCamp:n frontend frameworks -kurssilla. Siirsin projektin TypeScriptiin oppiakseni sitä paremmin.",
      },
      {
        name: "Laskin",
        gitHub: "https://github.com/Konstanenonen/Calculator",
        ...
        link: "https://konstanenonen.github.io/Calculator/",
        about:
          "Yksinkertainen laskin React.js -kirjastolla kehitettynä. Näyttää laskukaavan ja lopputuloksen omilla riveillään. Projekti oli osa kahden eri oppimisalustan kurssia: freeCodeCamp ja The Odin Project.",
      },
      {
        name: "Rumpukone",
        gitHub: "https://github.com/Konstanenonen/Drum-Machine",
        ...
        link: "https://konstanenonen.github.io/Drum-Machine/",
        about:
          "Soittaa äänen nappeja tai näppäimistöä painamalla. Näytössä lukee paras imitaationi kaikille äänille. Tämäkin kurssi oli osa freeCodeCamp:n frontend frameworks -kurssia",
      },
    ],
    footerItems: {
